...
参考课前资料提供的文档[《 seata的部署和集成.md 》](https://github.com/qingdog/cloud/blob/master/高级篇%20day02-分布式事务/资料/seata的部署和集成.md)：
...
* 非Seata事务的线程来操作同一记录可能会导致快照覆盖数据，从而出现操作数据丢失的情况（可能性极低）
...
[部署TC建表](https://github.com/seata/seata.github.io/blob/develop/docs/zh-cn/ops/deploy-guide-beginner.md#步骤二建表仅db)

* [全局锁lock_table](https://github.com/seata/seata/blob/2.x/script/server/db/mysql.sql#L42)

[AT模式]:http://seata.io/zh-cn/docs/dev/mode/at-mode.html

* [回滚日志表undo_log](https://github.com/seata/seata/wiki/AT-Mode#回滚日志表)
...
具体实现请参考课前资料提供的文档[《 seata的部署和集成.md#三tc服务的高可用和异地容灾 》](https://github.com/qingdog/cloud/blob/master/高级篇%20day02-分布式事务/资料/seata的部署和集成.md#三tc服务的高可用和异地容灾)：
